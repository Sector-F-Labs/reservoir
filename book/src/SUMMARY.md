...
- [API Reference](./api/overview.md)
  - [Chat Completions Endpoint](./api/chat-completions.md)
...
- [Architecture & Design](./architecture/overview.md)
  ...
  - [Context Enrichment](./architecture/context-enrichment.md)
  - [Conversation Threads (Synapses)](./architecture/synapses.md)

- [Features](./features/providers.md)
  - [Token Management](./features/token-management.md)
  - [Partitioning & Organization](./features/partitioning.md)
  - [Web Search Integration](./features/web-search.md)
